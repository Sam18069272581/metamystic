type PublicEnv = NodeJS.ProcessEnv | Partial<Record<"NEXT_PUBLIC_API_BASE_URL" | "NEXT_PUBLIC_APP_URL", string | undefined>>;
...
export function getApiBaseUrl(env: PublicEnv): string {
  return trimTrailingSlashes(env.NEXT_PUBLIC_API_BASE_URL ?? DEFAULT_API_BASE_URL);
}
